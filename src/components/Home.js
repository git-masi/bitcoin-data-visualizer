          ...
          <Col lg={4} className='mt-3'>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  The invetment tools give you an idea of return on investment
                  over different time periods, as well as useful information
            ...
            <Card className='mt-3'>
              <Card.Body>
                ...
                <Card.Text>
                  The historical price index shows you the value of bitcoin over
                  time.
                </Card.Text>
